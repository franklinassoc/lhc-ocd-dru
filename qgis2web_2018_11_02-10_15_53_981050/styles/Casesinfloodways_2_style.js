var size = 0;
var placement = 'point';
function categories_Casesinfloodways_2(feature, value, size, resolution, labelText,
                       labelFont, labelFill, bufferColor, bufferWidth,
                       placement) {
                switch(value.toString()) {case 'AWARD APPEALS IN PROGRESS':
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    break;
case 'FLOODWAY-HOLD APPLICATION':
                    return [ new ol.style.Style({
        image: new ol.style.Circle({radius: 4.0 + size,
...
case 'Survey Rejected':
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    break;
case 'Survey Rejected: Duplicate Address':
                    return [ new ol.style.Style({
        image: new ol.style.Circle({radius: 4.0 + size,
...
var style_Casesinfloodways_2 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var offsetY = 3;
    var placement = 'point';
    if (feature.get("Account_ID") !== null) {
        labelText = String(feature.get("Account_ID"));
    }
    
var style = categories_Casesinfloodways_2(feature, value, size, resolution, labelText,
